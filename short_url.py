...
'''
chars = '012345678ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz'
chars = [ chars[i] for i in xrange(0, len(chars)) ]
DEFAULT_ALPHABET = random.shuttle(chars)
'''
DEFAULT_ALPHABET = 'y46kaEOu73xchfZXmIb12rjYleU8iRPnGtLwFSHJgBo0CQsDq5MAzdvWNpVTK'
